...
class BANK2(IntEnum):
    ...
    ACCEL_CONFIG_1 = 0x14
    ACCEL_CONFIG_2 = 0x15
    PRGM_START_ADDRH = 0x50
    PRGM_START_ADDRL = 0x51
    FSYNC_CONFIG = 0x52
    TEMP_CONFIG = 0x53
    MOD_CTRL_USR = 0x54
    REG_BANK_SEL = 0x7F
...
BANK_LOOKUP = [BANK0, BANK1, BANK2, BANK3]


def select_bank(bank: int) -> int:
    if bank < 0 or bank > len(BANK_LOOKUP):
        raise Exception(f"Invalid bank value {bank}")

    return BANK_LOOKUP[bank].REG_BANK_SEL, bank << 4 & 0x30  # bits 5:4 of REG_BANK_SEL
